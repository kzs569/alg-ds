...
public class ChineseAddressParser {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ChineseAddressParser.parse("武汉市东湖新技术开发区天际路6号中冶南方国际社区二期北区2栋12层13室"));
        System.out.println(ChineseAddressParser.parse("万宁市兴隆镇长春城小区5号楼1单元101室"));

        ChineseAddress test= ChineseAddressParser.parse("河北省廊坊市广阳区曙光道春华里测绘院9号门店");
    }
